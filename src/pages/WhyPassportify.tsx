...
const WhyPassportify = () => {
  ...
  const features = [
    ...
    { name: 'DPP Score Calculation', passportify: true, others: true, spreadsheets: false },
    ...
    { name: 'Blockchain Anchoring', passportify: true, others: false, spreadsheets: false },
    { name: 'Single Tier Supplier Portal', passportify: true, others: true, spreadsheets: false },
    { name: 'Multi Tier Supplier Portal', passportify: true, others: false, spreadsheets: false },
